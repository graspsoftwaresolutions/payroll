            ...
            <div class="col-md-12">
              <form class="form-horizontal" id="EmployeeForm"  name="employee_select_form" action="{{ route('add_salary_save') }}" method="post">
                ...
                <div class="form-group{{ $errors->has('basic_salary') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-6">
                  <input type="text" readonly  id="basic_salary" name="basic_salary" value="{{ $salary_data->basic_salary }}" class="form-control" placeholder="{{ __('Basic Basic') }}">
                ...
                <div class="form-group{{ $errors->has('basic_salary') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-6">
                  <input type="text" style="poniter-events:none;" value="{{ $salary_data->deductions_total }}"  readonly id="deductions_total" name="deductions_total" class="form-control total_deductioncalc" placeholder="{{ __('Deductions Total Allowances') }}">
