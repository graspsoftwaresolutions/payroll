        ...
        <div class="box box-default">
            ...
            <form action="{{ url('/profile/update-profile') }}" method="post" name="user_edit_form" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <img src="{{ url('/public/profile_picture/' . $user['avatar']) }}" alt="$user['avatar']" class="img-responsive img-thumbnail">
                            @else
                ...
                <div class="box-footer">
                    <button type="submit" class="btn btn-primary btn-flat"> {{ __('Save') }}</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
