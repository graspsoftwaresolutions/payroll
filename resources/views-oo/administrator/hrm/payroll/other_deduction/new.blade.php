...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">{{ __('Manage Other Deduction') }}</li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">{{ __('Manage Other Deduction') }}</h3>
      ...
      <div class="box-body">
        ...
        <div class="col-md-12">
          ...
          <form class="form-horizontal" action="{{ route('other_deduction.save') }}" method="post">
            {{ csrf_field() }}

            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
              <label for="name" class="col-sm-3 control-label">{{ __('Deduction name') }}<span style="color:red"> *</span></label>
              <div class="col-sm-6">
               <input type="text" name="name" class="form-control" placeholder="{{ __('Other Deduction name') }}">
               @if ($errors->has('name'))
