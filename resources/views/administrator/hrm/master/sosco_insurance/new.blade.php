...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">{{ __('Add Socso Insurance') }}</li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">{{ __('Add Socso Insurance') }}</h3>
            ...
            {{ csrf_field() }}
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-10">
                  <button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-arrow-right"></i>{{ __('Add Socso Insurance') }} </button>
                </div>
              </div>
              <!-- /.end group -->
            </form>
