...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a>{{ __('Socso') }}</a></li>
      <li class="active">{{ __('Edit Socso ') }}</li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">{{ __('Edit Socso') }}</h3>
        ...
        <div class="col-md-12">
          <form class="form-horizontal" id="Soscoform" action="{{route('master.SoscoUpdate')}}" method="post">
            {{ csrf_field() }}
              ...
              <div class="col-sm-6">
               <input type="text" value="{{$row->wage_limit}}"  id="wage_limit" name="wage_limit" class="form-control" placeholder="{{ __('Wage Limit') }}">
                </div>
              ...
              <div class="col-sm-6">
               <input type="text" value="{{$row->from_amount}}" id="from_amount" name="from_amount" class="form-control" placeholder="{{ __('From Amount') }}">
                </div>
              ...
              <div class="col-sm-6">
                 <input type="text" value="{{$row->to_amount}}" id="to_amount" name="to_amount" class="form-control" placeholder="{{ __('From Amount') }}">
                </div>
              ...
              <div class="col-sm-6">
               <input type="text" value="{{$row->employee_contribution}}" id="employee_contribution" name="employee_contribution" class="form-control" placeholder="{{ __('Employee Contribution') }}">
                </div>
              ...
              <div class="col-sm-6">
               <input type="text" value="{{$row->employer_contribution}}" id="employer_contribution"  name="employer_contribution" class="form-control" placeholder="{{ __('Employer Contribution') }}">
                </div>
              ...
              <div class="col-sm-6">
               <input type="text"  value="{{$row->total_contribution}}" readonly id="total_contribution" name="total_contribution" class="form-control" placeholder="{{ __('Total Contribution') }}">
                </div>
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-10">
                  <button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-arrow-right"></i>{{ __('Update Socso') }} </button>
                </div>
              </div>
              <!-- /.end group -->
            </form>
