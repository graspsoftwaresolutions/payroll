...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">{{ __('Add Sosco Insurance') }}</li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">{{ __('Add Sosco Insurance') }}</h3>
      ...
      <div class="box-body">
        ...
        <!-- /.Notification Box -->
        <div class="col-md-12">
          <form class="form-horizontal" id="Soscoform" action="{{route('master.SoscoInsuranceSave')}}" method="post">
            {{ csrf_field() }}
              <!-- /.end group -->
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-10">
                  <button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-arrow-right"></i>{{ __('Add Sosco Insurance') }} </button>
                </div>
              </div>
              <!-- /.end group -->
            </form>
