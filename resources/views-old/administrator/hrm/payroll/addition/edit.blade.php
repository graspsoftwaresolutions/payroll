...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">{{ __(' Edit Addition') }}</li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        <!-- <h3 class="box-title">{{ __(' Edit Addition') }}</h3> -->
            ...
            <div class="form-group{{ $errors->has('cat_id') ? ' has-error' : '' }}">
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-10">
                  <button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-arrow-right"></i>{{ __('Update') }} </button>
                </div>
              </div>
              <!-- /.end group -->
            </form>
