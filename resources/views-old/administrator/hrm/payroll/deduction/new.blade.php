        ...
        <div class="col-md-12">
          ...
          <form class="form-horizontal" action="{{ route('deduction.save') }}" method="post">
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-6">
               <input type="text" name="name" class="form-control" placeholder="{{ __('Deduction name') }}">
               @if ($errors->has('name'))
            ...
            <div class="form-group{{ $errors->has('cat_id') ? ' has-error' : '' }}">
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-10">
                  <button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-arrow-right"></i>{{ __('Save') }} </button>
                </div>
              </div>
              <!-- /.end group -->
            </form>
