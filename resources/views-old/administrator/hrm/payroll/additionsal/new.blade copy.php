            ...
            <div class="col-md-12">
              <form class="form-horizontal" id="EmployeeForm"  name="employee_select_form" action="{{ route('add_salary_save') }}" method="post">
                ...
                <div class="form-group{{ $errors->has('basic_salary') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-6">
                  <input type="text"  id="basic_salary" name="basic_salary" class="form-control" placeholder="{{ __('Basic Basic') }}">
                ...
                <div id="epf_ee_section" class="hide form-group {{ $errors->has('epf_ee_id') ? ' has-error' : '' }}">
                  <label for="epf_ee_id" class="col-sm-3 control-label">{{ __('EPF_EE') }}</label>
                    <div id="epf_ee" class="col-sm-6">
                    <input type="text"  name="epf_ee_id" class="form-control  " id="epf_ee_id">
                          
                    </div>
                </div>   
                 <div id="ee_sosco_section" class="hide form-group {{ $errors->has('ee_sosco') ? ' has-error' : '' }}">
                  <label for="ee_sosco" class="col-sm-3 control-label">{{ __('EE_SOSCO') }}</label>
                    <div id="ee_soscos" class="col-sm-6">
                       <input type="text" name="ee_sosco" class="form-control  "   id="ee_sosco">
                          
                    </div>
                </div>  
                <div id="eis_sip_section" class="hide form-group{{ $errors->has('ee_sosco') ? ' has-error' : '' }}">
                  <label for="eis_sip" class="col-sm-3 control-label">{{ __('EIS_SIP') }}</label>
