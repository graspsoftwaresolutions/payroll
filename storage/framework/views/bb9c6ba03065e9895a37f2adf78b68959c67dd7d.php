  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <!-- /.Notification Box -->
        <div class="col-md-12">
          <form class="form-horizontal" id="Soscoform" action="<?php echo route('master.SoscoInsuranceUpdate'); ?>" method="post">
            <?php echo csrf_field(); ?>

              <input type="hidden" name="sosco_id" id="sosco_id" value="<?php echo $row->id; ?>">
              <!-- /.end group -->
              ...
              <div class="col-sm-6">
               <input type="text" value="<?php echo $row->wage_limit; ?>"  id="wage_limit" name="wage_limit" class="form-control" placeholder="<?php echo __('Wage Limit'); ?>">
                </div>
              ...
              <div class="col-sm-6">
               <input type="text" value="<?php echo $row->from_amount; ?>" id="from_amount" name="from_amount" class="form-control" placeholder="<?php echo __('From Amount'); ?>">
                </div>
              ...
              <div class="col-sm-6">
                 <input type="text" value="<?php echo $row->to_amount; ?>" id="to_amount" name="to_amount" class="form-control" placeholder="<?php echo __('From Amount'); ?>">
                </div>
              ...
              <div class="col-sm-6">
               <input type="text" value="<?php echo $row->employee_contribution; ?>" id="employee_contribution" name="employee_contribution" class="form-control" placeholder="<?php echo __('Employee Contribution'); ?>">
                </div>
              ...
              <div class="col-sm-6">
               <input type="text" value="<?php echo $row->employer_contribution; ?>" id="employer_contribution"  name="employer_contribution" class="form-control" placeholder="<?php echo __('Employer Contribution'); ?>">
                </div>
              ...
              <div class="col-sm-6">
               <input type="text"  value="<?php echo $row->total_contribution; ?>" readonly id="total_contribution" name="total_contribution" class="form-control" placeholder="<?php echo __('Total Contribution'); ?>">
                </div>
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-10">
                  <button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-arrow-right"></i><?php echo __('Update Sosco Insurance'); ?> </button>
                </div>
              </div>
              <!-- /.end group -->
            </form>
