...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			<?php echo __('Manage Notice'); ?>

		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo url('/dashboard'); ?>"><i class="fa fa-dashboard"></i><?php echo __('Dashboard'); ?> </a></li>
			<li><a><?php echo __('HRM'); ?></a></li>
			<li class="active"><?php echo __('Manage Notice'); ?></li>
		</ol>
	</section>
	...
	<section class="content">
		...
		<div class="box">
			<div class="box-header with-border">
				<h3 class="box-title"><?php echo __('Manage Notice'); ?></h3>
			...
			<div class="box-body">
				...
				<div  class="col-md-6">
                    <a href="<?php echo url('/hrm/notice/create'); ?>" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> <?php echo __('Add Notice'); ?></a>
                </div>
                <div  class="col-md-6">
				...
				<table  class="table table-bordered table-striped">
					<thead>
						<tr>
							...
							<th class="text-center"><?php echo __('Create At'); ?></th>
					...
					<tbody id="myTable">
						...
						<tr>
							...
							<td><?php echo str_limit($notice['description'], 65); ?></td>
							<td><?php echo $notice['name']; ?></td>
							<td><?php echo date("D d F Y h:ia", strtotime($notice['created_at'])); ?></td>
