          ...
          <div class="box-body">
            ...
            <div class="col-md-12">
              <form class="form-horizontal" id="EmployeeForm"  name="employee_select_form" action="<?php echo route('add_salary_save'); ?>" method="post">
                ...
                <!-- <div id="epf_ee_section" class="hide form-group <?php echo $errors->has('epf_ee_id') ? ' has-error' : ''; ?>">
                 ...
                 <!-- <div id="ee_sosco_section" class="hide form-group <?php echo $errors->has('ee_sosco') ? ' has-error' : ''; ?>">
                ...
                <!-- <div id="eis_sip_section" class="hide form-group<?php echo $errors->has('ee_sosco') ? ' has-error' : ''; ?>">
                  <label for="eis_sip" class="col-sm-3 control-label"><?php echo __('EIS_SIP'); ?></label>
