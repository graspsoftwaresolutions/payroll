...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
          <?php echo __(' Manage Sosco Insurance'); ?>
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div  class="col-md-3">
                <a href="<?php echo route('master.soscoinsurance_add'); ?>" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> <?php echo __('add new Sosco Insurance'); ?></a>
            </div>
                <div  class="col-md-3">
                    ...
                    <?php ($sl = 1); ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                    <a href="<?php echo route('master.SoscoInsuranceEdit',Crypt::encrypt($values->id)); ?>"><i class="icon fa fa-edit"></i> <?php echo __('Edit'); ?></a>
                                </td>
