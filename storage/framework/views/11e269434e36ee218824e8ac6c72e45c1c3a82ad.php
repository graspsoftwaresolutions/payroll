<div id="mainMenu">
    <ul class="sidebar-menu" data-widget="tree">
       ...
       <!-- <li class="treeview">
        ...
        <li class="treeview">
        <a href="#">
                <i class="fa fa-dollar text-purple"></i> <span><?php echo __('Master Management'); ?></span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <li><a href="<?php echo route('master.category_list'); ?>"><i class="fa fa-circle-o"></i> <?php echo __('category'); ?></a></li>
                <li><a href="<?php echo route('master.soscoInsurance_list'); ?>"><i class="fa fa-circle-o"></i> <?php echo __('Sosco Insurance'); ?></a></li>
                <li><a href="<?php echo route('master.sosco_list'); ?>"><i class="fa fa-circle-o"></i> <?php echo __('Sosco'); ?></a></li>
                <li><a href="<?php echo route('master.epf_list'); ?>"><i class="fa fa-circle-o"></i> <?php echo __('EPF'); ?></a></li>
            </ul>
        </li>
             ...
             <!--   <li><a href="<?php echo url('/hrm/salary-payments'); ?>"><i class="fa fa-circle-o"></i><?php echo __(' Make Payment'); ?></a></li>
              ...
              -->  <?php endif; // Entrust::can ?>
               ...
               <!-- <li><a href="<?php echo url('/hrm/provident-funds'); ?>"><i class="fa fa-circle-o"></i><?php echo __(' Provident Fund'); ?></a></li>
                --><?php endif; // Entrust::can ?>
                <li><a href="<?php echo route('payroll.addition'); ?>"><i class="fa fa-circle-o"></i><?php echo __(' Addition'); ?></a></li>
                <li><a href="<?php echo route('payroll.addition_sal'); ?>"><i class="fa fa-circle-o"></i><?php echo __('Manage Additional Salary'); ?></a></li>
                <li><a href="<?php echo route('payroll.deduction'); ?>"><i class="fa fa-circle-o"></i><?php echo __(' Deduction'); ?></a></li>
                <li><a href="<?php echo route('payroll.other_deduction'); ?>"><i class="fa fa-circle-o"></i><?php echo __('Other Deduction'); ?></a></li>
  ...
  <!--      <li class="treeview">
      ...
      <!--  <li class="treeview">
        ...
        <li>
            ...
            <form id="logout-formm" action="<?php echo route('logout'); ?>" method="POST">
                <?php echo csrf_field(); ?>
