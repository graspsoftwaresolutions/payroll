    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo __('Additional Salary List'); ?></h3>
            ...
            <div class="box-body">
                <div  class="col-md-4">
                    <!-- <a href="<?php echo url('/hrm/payroll'); ?>" class="btn btn-primary btn-flat"><i class="fa fa-edit"></i> <?php echo __('Manage Salary'); ?></a> -->
                     <a href="<?php echo route('payroll.additional_salary'); ?>" class="btn btn-primary btn-flat"><i class="fa fa-edit"></i> <?php echo __('Add Additional Salary'); ?></a>
                </div>
                        ...
                        <tbody id="myTable">
                            <?php $__currentLoopData = $data['salaries']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								 <tr>
									...
									<td><?php echo $salary->total_deductions; ?></td>
									<td><?php echo $salary->net_pay; ?></td>
									
									<td class="text-center"><a style="font-size:19px" class="btn btn-sm red waves-effect waves-circle waves-light" href="<?php echo route('add.salaryEdit',Crypt::encrypt($salary->id)); ?>"><i class="icon fa fa-edit"></i></a></td>
								</tr>
