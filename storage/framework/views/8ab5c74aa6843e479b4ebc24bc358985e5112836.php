  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <!-- /.Notification Box -->
        <div class="col-md-12">
          <form class="form-horizontal" id="Soscoform" action="<?php echo route('master.EpfSave'); ?>" method="post">
            <?php echo csrf_field(); ?>
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-10">
                  <button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-arrow-right"></i><?php echo __('Add EPF'); ?> </button>
                </div>
              </div>
              <!-- /.end group -->
            </form>
