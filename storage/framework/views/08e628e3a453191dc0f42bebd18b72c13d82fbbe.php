      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <!-- /.Notification Box -->
            <div class="col-md-12">
              <form class="form-horizontal" id="EmployeeForm"  name="employee_select_form" action="<?php echo route('add_salary_save'); ?>" method="post">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group<?php echo $errors->has('basic_salary') ? ' has-error' : ''; ?>">
                  ...
                  <div class="col-sm-6">
                  <input type="text" readonly  id="basic_salary" name="basic_salary" class="form-control" placeholder="<?php echo __('Basic Basic'); ?>">
                ...
                <div class="form-group<?php echo $errors->has('basic_salary') ? ' has-error' : ''; ?>">
                    ...
                    <div class="col-sm-6"> 
                    <a class="btn"  class="btn theme modal-trigger" data-toggle="modal" data-target="#myModal" title="Add" style="margin-top: 25px; background-color: #4a7885;color: white;">Add Allowances</a>
                ...
                <div class="form-group<?php echo $errors->has('epf_ee_id') ? ' has-error' : ''; ?>">
                  <label for="epf_ee_id" class="col-sm-3 control-label"><?php echo __('EPF_EE'); ?></label>
                    <div id="epf_ee" class="col-sm-6">
                    <input type="text"  name="epf_ee_id" class="form-control hide " id="epf_ee_id">
                          
                    </div>
                </div>   
                 <div class="form-group<?php echo $errors->has('ee_sosco') ? ' has-error' : ''; ?>">
                  <label for="ee_sosco" class="col-sm-3 control-label"><?php echo __('EE_SOSCO'); ?></label>
                    <div id="ee_soscos" class="col-sm-6">
                       <input type="text" name="ee_sosco" class="form-control hide "   id="ee_sosco">
                          
                    </div>
                </div>  
                <div class="form-group<?php echo $errors->has('ee_sosco') ? ' has-error' : ''; ?>">
                  <label for="ee_sosco" class="col-sm-3 control-label"><?php echo __('EIS_SIP'); ?></label>
                    <div id="eis_sips" class="col-sm-6">
                       <input type="text" name="eis_sip" class="form-control hide "   id="eis_sip">
                ...
                <div class="form-group<?php echo $errors->has('basic_salary') ? ' has-error' : ''; ?>">
                      ...
                      <div class="col-sm-6"> 
                          <a class="btn"  class="btn theme modal-trigger" data-toggle="modal" data-target="#mydeductionModal" title="Add" style="margin-top: 25px; background-color: #4a7885;color: white;">Add Deductions</a>
                  ...
                  <div class="col-sm-6">
                  <input type="text" style="poniter-events:none;"  id="deductions_total" name="deductions_total" class="form-control total_deductioncalc" placeholder="<?php echo __('Deductions Total Allowances'); ?>">
                ...
                <div class="form-group<?php echo $errors->has('basic_salary') ? ' has-error' : ''; ?>">
                      ...
                      <div class="col-sm-6"> 
                          <a class="btn"  class="btn theme modal-trigger" data-toggle="modal" data-target="#myotherdeductionModal" title="Add" style="margin-top: 25px; background-color: #4a7885;color: white;">Add Other Deductions</a>
                  ...
                  <label for="otherdeductions_total" class="col-sm-3 control-label"><?php echo __('Total Other Allowances'); ?></label>
                  <div class="col-sm-6">
                  ...
                  <div class="form-group<?php echo $errors->has('net_pay') ? ' has-error' : ''; ?>">
                    <label for="net_pay" class="col-sm-3 control-label"><?php echo __('Net Pay'); ?></label>
                      <div id="net_pay" class="col-sm-6">
                      <input type="text" name="net_pay" class="form-control"  placeholder="Net Pay" id="net_pay">
                      </div>
                  </div>

                  <div class="form-group<?php echo $errors->has('EPF_ER') ? ' has-error' : ''; ?>">
                    <label for="EPF_ER" class="col-sm-3 control-label"><?php echo __('EPF_ER'); ?></label>
                      <div id="EPF_ER" class="col-sm-6">
                      <input type="text" name="EPF_ER" class="form-control"  placeholder="EPF_ER" id="EPF_ER">
                      </div>
                  </div>

                  <div class="form-group<?php echo $errors->has('EPF_ER') ? ' has-error' : ''; ?>">
                    <label for="SOSCO_ER" class="col-sm-3 control-label"><?php echo __('SOSCO_ER'); ?></label>
                      <div id="SOSCO_ER" class="col-sm-6">
                  ...
                  <div class="form-group<?php echo $errors->has('SOSCO') ? ' has-error' : ''; ?>">
                    <label for="SOSCO_ER" class="col-sm-3 control-label"><?php echo __('SOSCO-[EIS/SIP - ER]'); ?></label>
                      <div id="SOSCO_EIS/SIP" class="col-sm-6">
              ...
              <div class="form-group">
                <div class="col-sm-5">  
                      ...
                      <select id="allowances" name="allowances[]" class="form-control select-validate" data-live-search="true" data-width="100%">
                          ...
                          <option selected="true" disabled value="0">Select Allownaces</option>
...
$(document).ready(function(){
  ...
  $('#employee_name').autocomplete({
    ...
    select: function (event, ui) {
         ...
         if(ui.item.EPF_EE == 1)
         {
           $('#epf_ee_id').removeClass('hide');
         }
         if(ui.item.EE_SOSCO == 1)
         {
           $('#ee_sosco').removeClass('hide');
         }
         if(ui.item.EIS_SIP == 1)
         {
           $('#eis_sip').removeClass('hide');
         }
...
if((deduction_allowances_id != '') &&  (deduction_price != '') )
{
    ...
    if (flag == 1) {
      ...
      $('#DeductionsExclusionTable tbody').append('<tr class="child" ><td>'+deduction_allowances_name+'<input type="hidden" id="deduction_allowances_name_'+slno+'" name="deduction_allowances_name[]" value="'+deduction_allowances_id+'"></td><td>'+deduction_price+'<input type="hidden" id="deduction_price_'+slno+'" name="deduction_price[]" value="'+price+'"></td><td><button type="button" class="btn btn-sm red waves-effect waves-circle waves-light removebutton" title="delete">Delete<i class="mdi mdi-delete"></i></td></tr>');
...
if((other_deduction_allowances_id != '') &&  (other_deduction_price != '') )
{
    ...
    if (flag == 1) {
      ...
      $('#OtherDeductionsExclusionTable tbody').append('<tr class="child" ><td>'+other_deduction_allowances_name+'<input type="hidden" id="other_deduction_allowances_name_'+slno+'" name="deduction_allowances_name[]" value="'+other_deduction_allowances_id+'"></td><td>'+other_deduction_price+'<input type="hidden" id="other_deduction_price_'+slno+'" name="other_deduction_price[]" value="'+other_deduction_price+'"></td><td><button type="button" class="btn btn-sm red waves-effect waves-circle waves-light removebutton" title="delete">Delete<i class="mdi mdi-delete"></i></td></tr>');
      var deduction_price = $('#deduction_price_'+slno).val();
...
function gross_calc() {
  ...
  $('#epf_ee_id').keyup(other_deductions_cal);
  $('#ee_sosco').keyup(other_deductions_cal);
  $('#eis_sip').keyup(other_deductions_cal);
   $("#deductions_total").keyup(other_deductions_cal);
...
function other_deductions_cal() {
   ...
   var otherdeductions_totall = $('#otherdeductions_total').val()=='' ? 0 : $("#otherdeductions_total").val();
    ...
    // if((epf_eee!='') && (epf_eee!=NaN) && (ee_soscoe!='') && (ee_soscoe!=NaN) && (eis_sipe!='') && (eis_sipe!=NaN)) 
    // {
    //     $('#total_deductions_hidden').val(parseFloat(epf_eee) + parseFloat(ee_soscoe) +  parseFloat(eis_sipe));
    // }
