<?php $__env->startSection('title', __('Manage Sosco')); ?>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
          <?php echo __(' Manage Sosco'); ?>

        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo url('/dashboard'); ?>"><i class="fa fa-dashboard"></i> <?php echo __('Dashboard'); ?></a></li>
            <li><a><?php echo __('Sosco '); ?></a></li>
            <li class="active"><?php echo __('Manage Sosco'); ?></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo __('Manage Sosco '); ?></h3>
            ...
            <div class="box-body">
                <div  class="col-md-3">
                <a href="<?php echo route('master.sosco_add'); ?>" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> <?php echo __('add new Sosco'); ?></a>
            </div>
                <div  class="col-md-3">
                ...
                <table  class="table table-bordered table-striped">
                    ...
                    <tbody id="myTable">
                    <?php ($sl = 1); ?>
                        <?php $__currentLoopData = $data['sosco_list']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo $sl ++; ?></td>
                            ...
                            <td class="text-center">
                                    <a href="<?php echo route('master.SoscoEdit',Crypt::encrypt($values->id)); ?>"><i class="icon fa fa-edit"></i> <?php echo __('Edit'); ?></a>
                            </td>
                        </tr>
