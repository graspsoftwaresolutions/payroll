  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <!-- /.Notification Box -->
        <div class="col-md-12">
          <form class="form-horizontal" id="Soscoform" action="<?php echo route('master.EpfUpdate'); ?>" method="post">
            <?php echo csrf_field(); ?>

              <input type="hidden" name="epf_id" id="epf_id" value="<?php echo $row->id; ?>">
              <!-- /.end group -->
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-10">
                  <button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-arrow-right"></i><?php echo __('Update EPF'); ?> </button>
                </div>
              </div>
              <!-- /.end group -->
            </form>
