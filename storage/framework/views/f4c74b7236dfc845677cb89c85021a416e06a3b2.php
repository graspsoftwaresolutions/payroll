              ...
              <form class="form-horizontal" id="EmployeeForm"  name="employee_select_form" action="<?php echo route('add_salary_save'); ?>" method="post">
				...
				<div class="form-group<?php echo $errors->has('gross_salary') ? ' has-error' : ''; ?>">
                  <label for="gross_salary" class="col-sm-3 control-label"><?php echo __('OT'); ?></label>
                    <div class="col-sm-6">
                    <input type="text"  id="ot" name="ot" class="form-control" readonly placeholder="<?php echo __('OT'); ?>">
                ...
                <div id="eis_sip_section" class=" form-group<?php echo $errors->has('eis_sip') ? ' has-error' : ''; ?>">
  ...
  $('#employee_name').autocomplete({
    // minChars: 1,
		...
		select: function (event, ui) {
			 ...
			 var url = "<?php echo url('/hrm/get-employee-master'); ?>" + '?user_id=' + ui.item.user_id;
			$.ajax({
				url: url,
				type: "GET",
				dataType: "json",
