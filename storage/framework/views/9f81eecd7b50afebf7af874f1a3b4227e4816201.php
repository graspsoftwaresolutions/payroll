...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a><?php echo __('Other sDeduction'); ?></a></li>
      <li class="active"><?php echo __('Manage Edit Other Deduction'); ?></li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"><?php echo __('Manage Edit Other Deduction'); ?></h3>
      ...
      <div class="box-body">
        ...
        <div class="col-md-12">
            ...
            <?php $row = $data['deduction_data'][0]; ?>
          <form class="form-horizontal" action="<?php echo route('otherdeduction.update'); ?>" method="post">
            <?php echo csrf_field(); ?>

            <input type="hidden" name="deduction_id" id="deduction_id" value="<?php echo $row->id; ?>">
            <div class="form-group<?php echo $errors->has('name') ? ' has-error' : ''; ?>">
              <label for="name" class="col-sm-3 control-label"><?php echo __('Deduction name'); ?><span style="color:red"> *</span></label>
              <div class="col-sm-6">
               <input type="text" name="name" class="form-control" value="<?php echo $row->name; ?>"  placeholder="<?php echo __('Deduction name'); ?>">
            ...
            <div class="form-group<?php echo $errors->has('cat_id') ? ' has-error' : ''; ?>">
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-10">
                  <button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-arrow-right"></i><?php echo __('Update Deduction'); ?> </button>
                </div>
              </div>
              <!-- /.end group -->
            </form>
