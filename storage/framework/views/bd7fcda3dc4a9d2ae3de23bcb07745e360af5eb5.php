  	...
  	<table id="page-length-option" class="display table2excel" width="auto">
		<thead>
			...
			<tr class="" style="text-align:center;">
				...
				<th colspan="<?php echo $additions_count; ?>" nowrap align="center" style="border: 1px solid #988989 !important;text-align:center;">ALLOW(RM)</th>
				...
				<th nowrap align="center" style="border: 1px solid #988989 !important;text-align:center;">EE</th>
				<th nowrap colspan="<?php echo $deductions_count; ?>" align="center" style="border: 1px solid #988989 !important;text-align:center;">STANDING INSTRUCTION - DEDUCTION</th>
				<th nowrap colspan="<?php echo $other_deductions_count; ?>" align="center" style="border: 1px solid #988989 !important;text-align:center;">OTHER DEDUCTION</th>
			...
			<tr class="" style="">
				<?php $__currentLoopData = $additions_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $additions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				
				<th nowrap style="border: 1px solid #988989 !important;"><?php echo $additions->name; ?></th>
				...
				<?php $__currentLoopData = $deductions_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deductions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<th nowrap style="border: 1px solid #988989 !important;"><?php echo $deductions->name; ?></th>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				...
				<?php $__currentLoopData = $other_deductions_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deductions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<th nowrap style="border: 1px solid #988989 !important;"><?php echo $deductions->name; ?></th>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		...
		<tbody class="" >
				...
				<tr >
					...
					<td style="border: 1px solid #988989 !important;"><?php echo $salary->name; ?></td>
					<td style="border: 1px solid #988989 !important;"></td>
					<td style="border: 1px solid #988989 !important;"></td>
					<td style="border: 1px solid #988989 !important;"></td>
					<td style="border: 1px solid #988989 !important;"></td>
					<td style="border: 1px solid #988989 !important;"><?php echo $salary->basic_salary; ?></td>
					<?php $__currentLoopData = $additions_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $additions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<?php
						$allowancecost = CommonHelper::getSalaryAllowanceCost($salary->id,$additions->additionid);
					?>
					<td style="border: 1px solid #988989 !important;"><?php echo $allowancecost; ?></td>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					<!--td style="border: 1px solid #988989 !important;"></td>
					<td style="border: 1px solid #988989 !important;"></td>
					<td style="border: 1px solid #988989 !important;"></td-->
					<td style="border: 1px solid #988989 !important;"><?php echo $salary->additional_allowance_total; ?></td>
					<td style="border: 1px solid #988989 !important;"><?php echo $salary->ot_amount; ?></td>
					<td style="border: 1px solid #988989 !important;"><?php echo $salary->gross_salary; ?></td>
					<td style="border: 1px solid #988989 !important;"></td>
					<td style="border: 1px solid #988989 !important;"><?php echo $salary->epf_ee_amount; ?></td>
					<td style="border: 1px solid #988989 !important;"><?php echo $salary->ee_sosco_amount; ?></td>
					<td style="border: 1px solid #988989 !important;"><?php echo $salary->eis_sip_amount; ?></td>
					
					<?php $__currentLoopData = $deductions_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deductions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<?php
						$deductioncost = CommonHelper::getSalaryAllowanceCost($salary->id,$deductions->additionid);
					?>
					<td style="border: 1px solid #988989 !important;"><?php echo $deductioncost; ?></td>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					...
					?>
					<td style="border: 1px solid #988989 !important;"><?php echo $adddeductioncost; ?></td>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					
					<td style="border: 1px solid #988989 !important;"><?php echo $salary->total_deductions; ?></td>
					<td style="border: 1px solid #988989 !important;"><?php echo $salary->net_pay; ?></td>
					<td style="border: 1px solid #988989 !important;"><?php echo $salary->epf_percent; ?></td>
					<td style="border: 1px solid #988989 !important;"><?php echo $salary->epf_er; ?></td>
					<td style="border: 1px solid #988989 !important;"><?php echo $salary->sosco_er; ?></td>
					<td style="border: 1px solid #988989 !important;"><?php echo $salary->sosco_eissip; ?></td>
