...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><?php echo __('Edit Additional Salary'); ?></li>
    </ol>
  </section>
  <!-- Main content -->`
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title"><?php echo __('Edit Additional Salary'); ?></h3>
            ...
            <div class="col-md-12">
              <form class="form-horizontal" id="EmployeeForm"  name="employee_select_form" action="<?php echo route('add_additionalsalary_save'); ?>" method="post">
                ...
                <div class="form-group<?php echo $errors->has('user_id') ? ' has-error' : ''; ?>">
                  ...
                  <input class="form-control clearable" type="text" id="employee_name" readonly placeholder="Search Customer" value="<?php echo $memberinfo->name; ?>" name="employee_name">
                ...
                <div class="form-group<?php echo $errors->has('basic_salary') ? ' has-error' : ''; ?>">
                  ...
                  <div class="col-sm-6">
                  <input type="text"  id="basic_salary" name="basic_salary" class="form-control" value="<?php echo $salary_data->basic_salary; ?>" placeholder="<?php echo __('Basic Basic'); ?>">
                ...
                <div class="form-group<?php echo $errors->has('gross_salary') ? ' has-error' : ''; ?>">
                  <label for="gross_salary" class="col-sm-3 control-label"><?php echo __('OT'); ?></label>
                    <div class="col-sm-6">
                    <input type="text"  id="ot" name="ot" class="form-control" value="<?php echo $salary_data->ot_amount; ?>" placeholder="<?php echo __('OT'); ?>">
					<input type="text"  id="net_salary" name="net_salary" value="<?php echo $salary_data->ot_amount+$salary_data->basic_salary; ?>" class="form-control hide" placeholder="">
                    </div>
                </div>
                <div class="form-group<?php echo $errors->has('basic_salary') ? ' has-error' : ''; ?>">
                    ...
                    <a class="btn"  class="btn theme modal-trigger" data-toggle="modal" data-target="#myModal" title="Add" style="margin-top: 0px; background-color: #4a7885;color: white;">Add Allowances</a>
                      <table id="ExclusionTable" class="table-centered table-hover paper update-table somting">
							...
							<tbody id="exampleTable">
							   <?php $__currentLoopData = $data['salary_allow_addition']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							   <tr class="child">
									<td><?php echo $addition->name; ?><input type="hidden" id="allowances_name<?php echo $addition->additionid; ?>" name="allowances_name[]" value="<?php echo $addition->additionid; ?>"></td>
									<td><?php echo $addition->amount; ?><input type="hidden" class="addition_price" id="price_<?php echo $addition->additionid; ?>" name="price[]" value="<?php echo $addition->amount; ?>"></td>
                  ...
                  <div class="col-sm-6">
                  <input type="text" readonly  id="addition_total" id="addition_total" name="addition_total" value="<?php echo $salary_data->additional_allowance_total; ?>" class="form-control" placeholder="<?php echo __('Additional Total Allowances'); ?>">
                  ...
                  <label for="gross_salary" class="col-sm-3 control-label"><?php echo __('Gross Salary'); ?></label>
                    <div class="col-sm-6">
                    <input type="text" readonly  id="gross_salary" name="gross_salary" class="form-control" value="<?php echo $salary_data->gross_salary; ?>" placeholder="<?php echo __('Gross Basic'); ?>">
                    </div>
                </div>
                 <div id="epf_ee_section" class=" form-group <?php echo $errors->has('epf_ee_id') ? ' has-error' : ''; ?>">
					<label for="epf_ee_id" class="col-sm-3 control-label"><?php echo __('EPF-EE'); ?>
						...
						<input id="epf_ee_check" name="epf_ee_check" onClick="return EnableEpfBox()" <?php if($salary_data->epf_ee_amount>0): ?> checked <?php endif; ?> type="checkbox" value="1" />
					</label>
					
					
                    <div id="epf_ee" class="col-sm-6 <?php if($salary_data->epf_ee_amount==0 || $salary_data->epf_ee_amount==''): ?> hide <?php endif; ?>">
						<input type="text"  name="epf_ee_id" class="form-control  " value="<?php echo $salary_data->epf_ee_amount; ?>" id="epf_ee_id">
				...
				<div id="ee_sosco_section" class=" form-group <?php echo $errors->has('ee_sosco') ? ' has-error' : ''; ?>">
                  <label for="ee_sosco" class="col-sm-3 control-label"><?php echo __('EE-SOSCO'); ?>
					...
					<input id="epf_sosco_check" name="epf_sosco_check" onClick="return EnablesoscoBox()" <?php if($salary_data->ee_sosco_amount>0): ?> checked <?php endif; ?> type="checkbox" value="1"/>
				  </label>
                    <div id="ee_soscos" class="col-sm-6 <?php if($salary_data->ee_sosco_amount==0 || $salary_data->ee_sosco_amount==''): ?> hide <?php endif; ?>">
                       <input type="text" name="ee_sosco" class="form-control  " value="<?php echo $salary_data->ee_sosco_amount; ?>"  id="ee_sosco">
                ...
                <div id="eis_sip_section" class=" form-group<?php echo $errors->has('ee_sosco') ? ' has-error' : ''; ?>">
                  <label for="eis_sip" class="col-sm-3 control-label"><?php echo __('EIS-SIP'); ?>
					...
					<input id="epf_sip_check" name="epf_sip_check" onClick="return EnablesipBox()" <?php if($salary_data->eis_sip_amount>0): ?> checked <?php endif; ?> type="checkbox" value="1"/>
				  </label>
                    <div id="eis_sips" class="col-sm-6 <?php if($salary_data->eis_sip_amount==0 || $salary_data->eis_sip_amount==''): ?> hide <?php endif; ?>">
                       <input type="text" name="eis_sip" class="form-control " value="<?php echo $salary_data->eis_sip_amount; ?>"   id="eis_sip">
                ...
                <div class="form-group<?php echo $errors->has('basic_salary') ? ' has-error' : ''; ?>">
                      ...
                      <div class="col-sm-6"> 
                          ...
                          <table id="DeductionsExclusionTable" class="table-centered table-hover paper update-table deduction">
                                      ...
                                      <tbody id="exampleTable">
                                        <?php $__currentLoopData = $data['salary_allow_deduction']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									   <tr class="child">
											<td><?php echo $addition->name; ?><input type="hidden" id="allowances_name<?php echo $addition->additionid; ?>" name="allowances_name[]" value="<?php echo $addition->additionid; ?>"></td>
											<td><?php echo $addition->amount; ?><input type="hidden" class="addition_price" id="price_<?php echo $addition->additionid; ?>" name="price[]" value="<?php echo $addition->amount; ?>"></td>
											<td><button type="button" class="btn btn-sm red waves-effect waves-circle waves-light removebutton" title="delete">Delete<i class="mdi mdi-delete"></i></button></td>
                  ...
                  <div class="col-sm-6">
                  <input type="text" style="poniter-events:none;"  readonly id="deductions_total" name="deductions_total" value="<?php echo $salary_data->deductions_total; ?>" class="form-control total_deductioncalc" placeholder="<?php echo __('Deductions Total Allowances'); ?>">
                ...
                <div class="form-group<?php echo $errors->has('basic_salary') ? ' has-error' : ''; ?>">
                      ...
                      <div class="col-sm-6"> 
                          ...
                          <table id="OtherDeductionsExclusionTable" class="table-centered table-hover paper update-table otherdeductions">
                                      ...
                                      <tbody id="exampleTable">
                                          <?php $__currentLoopData = $data['salary_other_deduction']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									   <tr class="child">
											<td><?php echo $addition->name; ?><input type="hidden" id="allowances_name<?php echo $addition->additionid; ?>" name="allowances_name[]" value="<?php echo $addition->additionid; ?>"></td>
											<td><?php echo $addition->amount; ?><input type="hidden" class="addition_price" id="price_<?php echo $addition->additionid; ?>" name="price[]" value="<?php echo $addition->amount; ?>"></td>
											<td><button type="button" class="btn btn-sm red waves-effect waves-circle waves-light removebutton" title="delete">Delete<i class="mdi mdi-delete"></i></button></td>
                  ...
                  <div class="col-sm-6">
                  <input type="text" readonly  id="otherdeductions_total" name="otherdeductions_total" value="<?php echo $salary_data->otherdeductions_total; ?>" class="form-control" placeholder="<?php echo __('Other deductions Total Allowances'); ?>">
                  ...
                  <div class="form-group<?php echo $errors->has('ee_sosco') ? ' has-error' : ''; ?>">
                    <label for="total_deductions" class="col-sm-3 control-label"><?php echo __('Total Deductions'); ?></label>
                      <div class="col-sm-6">
                      <input readonly type="text" name="total_deductions" class="form-control" value="<?php echo $salary_data->total_deductions; ?>"  placeholder="Total Deductions" id="total_deductions">
                      </div>
                  </div>
                  <div class="form-group<?php echo $errors->has('net_pay') ? ' has-error' : ''; ?>">
                    <label for="net_pay" class="col-sm-3 control-label"><?php echo __('Net Pay'); ?></label>
                      <div class="col-sm-6">
                      <input type="text" name="net_pay" class="form-control" readonly value="<?php echo $salary_data->net_pay; ?>"  placeholder="Net Pay" id="net_pay">
                      </div>
                  </div>
				   ...
				   <div class="form-group<?php echo $errors->has('EPF_ER') ? ' has-error' : ''; ?>">
						...
						<div id="EPF_ERidper" class="col-sm-6 <?php if($salary_data->epf_ee_amount==0 || $salary_data->epf_ee_amount==''): ?> hide <?php endif; ?>">
							<select name="EPF_ERper" onchange="return CalculateEPAmount(this.value)" id="EPF_ERper" class="form-control">
								<option value="13" <?php if($salary_data->epf_percent==13): ?> selected <?php endif; ?> >13</option>
								<option value="17" <?php if($salary_data->epf_percent==17): ?> selected <?php endif; ?>>17</option>
							</select>
                  ...
                  <div class="form-group<?php echo $errors->has('EPF_ER') ? ' has-error' : ''; ?>">
                    <label for="EPF_ER" class="col-sm-3 control-label"><?php echo __('EPF-ER'); ?></label>
                      <div id="EPF_ERid" class="col-sm-6 <?php if($salary_data->epf_ee_amount==0 || $salary_data->epf_ee_amount==''): ?> hide <?php endif; ?>">
                      <input type="text" name="EPF_ER" class="form-control" value="<?php echo $salary_data->epf_er; ?>"  placeholder="EPF_ER" id="EPF_ER">
                      <input type="text" name="EPF_ERref" class="form-control hide" value="<?php echo $salary_data->epf_er; ?>"  placeholder="EPF_ER" id="EPF_ERref">
                      </div>
                  </div>

                  <div class="form-group<?php echo $errors->has('EPF_ER') ? ' has-error' : ''; ?>">
                    <label for="SOSCO_ER" class="col-sm-3 control-label"><?php echo __('SOSCO-ER'); ?></label>
                      <div id="SOSCO_ERid" class="col-sm-6  <?php if($salary_data->ee_sosco_amount==0 || $salary_data->ee_sosco_amount==''): ?> hide <?php endif; ?>">
                      <input type="text" name="SOSCO_ER" class="form-control" value="<?php echo $salary_data->sosco_er; ?>"  placeholder="SOSCO_ER" id="SOSCO_ER">
                      </div>
                  </div>
                  ...
                  <div class="form-group<?php echo $errors->has('SOSCO') ? ' has-error' : ''; ?>">
                    <label for="SOSCO_ER" class="col-sm-3 control-label"><?php echo __('SOSCO-[EIS/SIP - ER]'); ?></label>
                      <div id="SOSCO_EISid" class="col-sm-6  <?php if($salary_data->eis_sip_amount==0 || $salary_data->eis_sip_amount==''): ?> hide <?php endif; ?>">
                      <input type="text" name="SOSCO_EISSIP" class="form-control" value="<?php echo $salary_data->sosco_eissip; ?>"  placeholder="SOSCO-[EIS/SIP - ER]" id="SOSCO_EISSIP_ER">
                      </div>
                  </div>
