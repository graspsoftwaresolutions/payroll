...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
     <?php echo __('SALARY PAYMENT'); ?> 
    </h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo url('/dashboard'); ?>"><i class="fa fa-dashboard"></i> <?php echo __('Dashboard'); ?></a></li>
      <li><a><?php echo __('Salary'); ?></a></li>
      <li class="active"><?php echo __('Manage Salary Payment'); ?></li>
    </ol>
  </section>
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <div class="col-md-12">
          ...
          <form class="form-horizontal" action="<?php echo url('/hrm/salary-payments/go'); ?>" method="post">
            <?php echo csrf_field(); ?>
