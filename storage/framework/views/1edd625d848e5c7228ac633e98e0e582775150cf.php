...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><?php echo __('Manage Edit Deduction'); ?></li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"><?php echo __('Manage Edit Deduction'); ?></h3>
      ...
      <div class="box-body">
        ...
        <div class="col-md-12">
          ...
          <form class="form-horizontal" action="<?php echo route('deduction.update'); ?>" method="post">
            <?php echo csrf_field(); ?>
