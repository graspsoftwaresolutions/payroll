...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('/hrm/category_list', 'MasterController@categoryList')->name('master.category_list');
	Route::get('/hrm/category_add', 'MasterController@categoryAdd')->name('master.caregory_add');
	Route::post('/hrm/category_save', 'MasterController@categorySave')->name('master.CategorySave');
	Route::get('/hrm/category_edit/{id}', 'MasterController@categoryEdit')->name('master.caregoryEdit');
	Route::post('/hrm/category_update', 'MasterController@categoryUpdate')->name('master.CategoryUpdate');

	//Sosco Insuarnce 
	Route::get('/hrm/sosco_insurance_list', 'MasterController@soscoInsuranceList')->name('master.soscoInsurance_list');
	Route::get('/hrm/sosco-insurance_add', 'MasterController@soscoinsuranceAdd')->name('master.soscoinsurance_add');
	Route::post('/hrm/SoscoInsurance_save', 'MasterController@SoscoInsuranceSave')->name('master.SoscoInsuranceSave');
	Route::get('/hrm/sosco_insurance_Edit/{id}', 'MasterController@soscoInsuranceEdit')->name('master.SoscoInsuranceEdit');
	Route::post('/hrm/sosco_update', 'MasterController@SoscoInsuranceUpdate')->name('master.SoscoInsuranceUpdate');

	//Sosco
	Route::get('/hrm/sosco_list', 'MasterController@soscoList')->name('master.sosco_list');
	Route::get('/hrm/sosco_add', 'MasterController@soscoAdd')->name('master.sosco_add');
	Route::post('/hrm/Sosco_save', 'MasterController@SoscoSave')->name('master.SoscoSave');
	Route::get('/hrm/sosco_Edit/{id}', 'MasterController@soscoEdit')->name('master.SoscoEdit');
	Route::post('/hrm/soscoUpdate', 'MasterController@soscoUpdate')->name('master.SoscoUpdate');


	//epf
	Route::get('/hrm/epf_list', 'MasterController@epfList')->name('master.epf_list');
	Route::get('/hrm/Epf_add', 'MasterController@epfAdd')->name('master.epf_add');
	Route::post('/hrm/Epf_save', 'MasterController@epfSave')->name('master.EpfSave');
	Route::get('/hrm/Epf_Edit/{id}', 'MasterController@epfEdit')->name('master.EpfEdit');
	Route::post('/hrm/EpfUpdate', 'MasterController@epfUpdate')->name('master.EpfUpdate');
	//Route::delete('epf_delete/{id}','MasterController@Epfdestroy')->name('master.EpfDestroy');

	//Payroll Addition
	Route::get('/hrm/addition_list', 'PayrollController@additionList')->name('payroll.addition');
	Route::get('/hrm/addition_new', 'PayrollController@additionNew')->name('addition_new');
	Route::post('/hrm/addition_save', 'PayrollController@additionSave')->name('addition.save');
	Route::get('/hrm/addition_edit/{id}', 'PayrollController@addtionEdit')->name('master.addtionEdit');
	Route::post('/hrm/addtion_update', 'PayrollController@addtionUpdate')->name('addition.update');
	Route::get('/hrm/addtionDelete/{id}', 'PayrollController@additionDelete')->name('payroll.addtionDelete');

	//Payroll Deduction
	Route::get('/hrm/deduction_list', 'PayrollController@deductionList')->name('payroll.deduction');
	Route::get('/hrm/deduction_new', 'PayrollController@deductionNew')->name('deduction_new');
	Route::post('/hrm/deduction_save', 'PayrollController@deductionSave')->name('deduction.save');
	Route::get('/hrm/deduction_edit/{id}', 'PayrollController@deductionEdit')->name('master.deductionEdit');
	Route::post('/hrm/deduction_update', 'PayrollController@deductionUpdate')->name('deduction.update');
	Route::get('/hrm/deductionDelete/{id}', 'PayrollController@deductionDelete')->name('payroll.deductionDelete');

	//Other deuctions
	
	Route::get('/hrm/other_deduction_list', 'PayrollController@otherdeductionList')->name('payroll.other_deduction');
	Route::get('/hrm/other_deduction_new', 'PayrollController@otherdeductionNew')->name('other_deduction_new');
	Route::post('/hrm/other_deduction', 'PayrollController@otherdeductionSave')->name('other_deduction.save');
	Route::get('/hrm/other_deduction_edit/{id}', 'PayrollController@otherdeductionEdit')->name('master.otherdeductionEdit');
	Route::post('/hrm/other_deduction_update', 'PayrollController@otherdeductionUpdate')->name('otherdeduction.update');
	Route::get('/hrm/otherdeductionDelete/{id}', 'PayrollController@otherdeductionDelete')->name('payroll.otherdeductionDelete');
	...
	Route::post('update_bonus_save','PayrollController@UpdateBonusSave')->name('update_bonus_save');
    ...
    Route::get('/hrm/additional_salary', 'PayrollController@additional_salary')->name('payroll.additional_salary');
	
	Route::get('/hrm/get-salary-contribution', 'PayrollController@getSalaryContribution')->name('payroll.salarycontribution');
	Route::get('/hrm/get-sosco-contribution', 'PayrollController@getSoscoContribution')->name('payroll.soscocontribution');
	Route::get('/hrm/get-soscoins-contribution', 'PayrollController@getSoscoInsContribution')->name('payroll.soscoinscontribution');
	
	Route::post('add_additionalsalary_save','PayrollController@addAdditionalsalarySave')->name('add_additionalsalary_save');
	...
	Route::get('/hrm/yearly_report', 'PayrollController@yearlyReport')->name('reports.yearly');
	Route::get('/hrm/yearlydeductions_print', 'PayrollController@yearlyDeductionsPrint')->name('reports.yearlydeductions');
